  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#F7F7F2]/90 backdrop-blur-sm border-b border-[#2D2D2D]/10">
      <div className="max-w-[1280px] mx-auto px-6 h-[78px] flex items-center gap-6">
        {/* Logo */}
        <Link href="/" className="text-[#6B2D3E] text-2xl font-medium tracking-tight lowercase flex-shrink-0">
          omilearn
        </Link>
        ...
        <div className="flex items-center gap-3 ml-auto">
          {/* Search bar */}
          <div className="flex items-center gap-2 px-4 py-2 rounded-full border-2 border-[#2D2D2D]/10 bg-[#F1F1EC] min-w-[180px]">
