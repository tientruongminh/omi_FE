...
import { RoadmapNode, RoadmapEdge } from '@/features/roadmap/data/roadmap-data';
import { mindmapNodes } from '@/features/learn/data/learning-data';
...
export function RoadmapGraph({ nodes: initialNodes, edges: initialEdges, onNodesChange, onEdgesChange, onNodeClick }: Props) {
